  ...
  function (ClientLayer, LabelsLayer, d3, L, moment, LocationMarker, rbush) {
    ...
    var AddLayerButton = L.Control.extend({
        ...
        onAdd: function () {
          ...
          button.textContent = "\uF218"
          button.setAttribute("title", "Ebene zur Karte hinzufügen")
    ...
    var LocateButton = L.Control.extend({
        ...
        onAdd: function () {
          ...
          button.textContent = "\uF2E9"
          button.setAttribute("title", "Springe zum eigenen Standort")
    ...
    var CoordsPickerButton = L.Control.extend({
      ...
      onAdd: function () {
        ...
        button.textContent = "\uF2A6"
        button.setAttribute("title", "Zeige angeklickte Geo-Koordinaten")
    ...
    return function (config, linkScale, sidebar, router, buttons) {
      ...
      function showCoordinates(e) {
        window.prompt("Geo-Koordinaten (Breitengrad, Längengrad)", e.latlng.lat.toFixed(6) + ", " + e.latlng.lng.toFixed(6))
        disableCoords()
      }
      ...
      addButton(new AddLayerButton(function () {
        /*eslint no-alert:0*/
        var layerName = prompt("Leaflet-Anbieter zum Hinzufügen einer neuen Datenebene angeben:")
        addLayer(layerName)
      }))
