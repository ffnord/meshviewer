...
function (moment, Router, L, GUI, numeral) {
  return function (config) {
    function handleData(data) {
      ...
      if (dataNodes.version !== 2) {
        var err = "Unsupported nodes.json version: " + dataNodes.version
        throw err
      }

      if (dataGraph.version !== 1) {
        var err = "Unsupported graph.json version " + dataGraph.version
        throw err
      }
