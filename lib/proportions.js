define(["chroma-js", "virtual-dom", "numeral-intl", "vercomp" ],
  ...
  return function (config) {
    ...
    var vpnTable = document.createElement("table")
    vpnTable.classList.add("proportion")
    ...
    self.setData = function (data) {
      ...
      var vpnDict = count(onlineNodes, ["statistics", "vpn_peers"])
      ...
      fillTable(uplinkTable, uplinkDict.sort(function (a, b) { return b[1] - a[1] }))
      fillTable(vpnTable, vpnDict.sort(function (a, b) { return b[1] - a[1] }))
    }
    ...
    self.render = function (el) {
      ...
      h2 = document.createElement("h2")
      h2.textContent = "VPN-Peer"
      el.appendChild(h2)
      el.appendChild(vpnTable)
